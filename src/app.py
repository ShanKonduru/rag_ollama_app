...
def create_and_save_vector_store(text_chunks, version):
    ...
    vectorstore.save_local(folder_path=version_dir,  index_name="knowledge_base")
...
def load_vector_store_by_version(version):
    ...
    if os.path.exists(version_dir):
        ...
        vectorstore = FAISS.load_local(version_dir, embeddings, allow_dangerous_deserialization=True, index_name="knowledge_base")
